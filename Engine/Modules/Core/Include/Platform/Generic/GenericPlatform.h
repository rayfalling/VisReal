...
namespace Engine::Core::Types {
	...
	struct GenericPlatform {
		...
		typedef WCHAR TCHAR;
		// A switchable character  - In-memory only.  Either CHAR or CHAR, depending on a licensee's requirements.

		typedef SelectIntPointerType<uint32, uint64, sizeof(void*)>::TIntPointer PTR_SIZE;
		// unsigned int the same size as a pointer
		typedef SelectIntPointerType<int32, int64, sizeof(void*)>::TIntPointer SPTR_SIZE;
